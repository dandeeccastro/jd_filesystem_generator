...
## Installation 
- Clone this repository and make sure you have `pip` installed
...
- Run`main.py` as a shell script `./main.py` or with Python `python src/main.py` 
...
- [ ] New features
    - [ ] Add help section
    - [ ] Set meta flag to generate 00 - 09 range 
